...
void BuscaWhere(int escolha,int valor,char *nome,FILE *arqConvertido);
// void BuscaPorPopularidade(int valor,FILE *arqConvertido);
// void BuscaPorPeso(int valor,FILE *arqConvertido);
// void BuscaPorOrigem(char *nome,FILE *arqConvertido);
// void BuscaPorDestino(char *nome,FILE *arqConvertido);
//Funcionalidade [1]
